...
def run_survey_etl(event_data: List[EngagementRecord]) -> List[dict]:
    dept_conversion_dict = {
        ...
        'Biological Sciences': Departments.BIO_SCI.value.name,
        'Brain Sciences': Departments.BRAIN_SCI.value.name,
        ...
        'History': Departments.HISTORY.value.name,
        'Humanities': Departments.HUMANITIES.value.name,
